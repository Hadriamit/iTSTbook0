...
latex_documents = [
  ('index', 'AlgTest.tex', 'Test',
   'Jaks Hadriamit', 'manual'),
]
...
texinfo_documents = [
  ('index', 'AlgTest', 'Test',
   'Jaks Hadriamit', 'AlgTest', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = 'Test'
epub_author = 'Jaks Hadriamit'
epub_publisher = 'Jaks Hadriamit'
epub_copyright = '2016, Jaks Hadriamit'
